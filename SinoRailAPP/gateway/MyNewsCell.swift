...
//屏幕的宽
let MyKScreenWidth = UIScreen.main.bounds.size.width
//屏幕的高
let MyKScreenHeight = UIScreen.main.bounds.size.height
...
class MyNewsCell: UITableViewCell {
    ...
    func setupViews(){
        ...
        //标题
        newsTitleLabel = UILabel(frame: CGRect(x: 80, y: 5, width: MyKScreenWidth - 80, height: 25))
        ...
        //新闻内容
        newsContentLabel = UILabel(frame: CGRect(x: 80, y: 35, width: MyKScreenWidth-80, height: 25))
