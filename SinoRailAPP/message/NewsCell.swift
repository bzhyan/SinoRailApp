...
class NewsCell: UITableViewCell {
    ...
    func setupViews(){
        ...
        //标题
        newsTitleLabel = UILabel(frame: CGRect(x: 80, y: 5, width: KScreenWidth - 80, height: 25))
        ...
        //新闻内容
        newsContentLabel = UILabel(frame: CGRect(x: 80, y: 35, width: KScreenWidth-80, height: 25))
